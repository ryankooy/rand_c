...
void HashAddH(KeyType key, ValType value, KeyCopyF copyKey, ValCopyF copyVal, KeyHashF hashKey, KeyCmprF keySame)
{
...
int main()
{
  ...
  static int valueList[] = { 1, 43, 640, 747, 42, 42 };
  int ix;

  for (ix = 0; ix < 6; ix++)
    HashAdd(keyList[ix], valueList[ix]);
